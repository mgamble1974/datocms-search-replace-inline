...
type Props = { ctx: RenderItemFormSidebarPanelCtx };
...
export default function SidebarPanel({ ctx }: Props) {
  ...
  // Live preview snippets (voor vervangen) — gemarkeerde zoektermen in huidige tekst
  ...
  const handleReplace = async () => {
    ...
    // Sla huidige staat op in geschiedenis (max 3 stappen)
  ...
  return (
    <Canvas ctx={ctx}>
      <div style={{ backgroundColor: '#dbeafe', borderRadius: '8px', padding: '16px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        {/* Live preview: zoektermen gemarkeerd in oranje */}
        ...
        {/* Na vervangen: vervangen tekst gemarkeerd in geel */}
